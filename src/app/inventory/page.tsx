      ...
      <div className="p-6 space-y-5">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 space-y-3">
          ...
          <div className="flex gap-1.5 flex-wrap">
            {CATEGORIES.map(c => {
              const count = c === 'all' ? inventoryItems.length : inventoryItems.filter(i => i.category === c).length;
              return (
                <button
                  key={c}
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <span className={cn('px-1.5 py-0.5 rounded border text-xs', getPIPOStatusColor(item.pipoStatus))}>
                            {getPIPOStatusLabel(item.pipoStatus)}
                          </span>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3">
                          <span className={cn(item.incoming > 0 ? 'text-blue-400' : 'text-gray-600')}>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 text-xs">
                              ...
                              {item.notes && (
                                <div className="col-span-2 md:col-span-4">
                                  ...
                                  <p className="text-amber-300">{item.notes}</p>
                                </div>
                              )}
                            </div>
                          </td>
